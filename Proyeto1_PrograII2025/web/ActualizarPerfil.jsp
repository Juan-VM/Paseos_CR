...
<html>
    ...
    <body>
        ...
        <%
            ...
            if (dbh.ActualizarPerfil(em, nombre, pass, id)) {
        %>
        <div class="container d-flex justify-content-center">
            <div class="card shadow-lg p-4">
                <div class="card-body">
                    <h4 class="card-title text-success"><i class="fas fa-check-circle"></i> ¡Perfil actualizado!</h4>
                    <p class="card-text">Tu perfl se a Actualizado con éxito.</p>
                    <a href="perfil.jsp?id=<%=id%>" class="btn btn-success w-100"><i class="fas fa-thumbs-up"></i>Aceptar</a>
                </div>
            </div>
        </div>
        <%} else {%>
        <div class="container d-flex justify-content-center">
            <div class="card shadow-lg p-4">
                <div class="card-body">
                    ...
                    <p class="card-text">Ocurrió un error al Actualizar el Perfil. Inténtalo de nuevo...</p>
                    <a href="perfil.jsp?id=<%=id%>" class="btn btn-danger w-100"><i class="fas fa-times"></i>Intentar de nuevo</a>
                </div>
            </div>
        </div>
        <%
